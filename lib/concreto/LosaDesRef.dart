...
import 'package:lonchi_ing_gd/MyWidgets/MyInputMalla.dart';
...
class LosaDesRef extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return LosaDesRefScreen();
  }
}

class LosaDesRefScreen extends StatefulWidget {
  State createState() =>  LosaDesRefScreenState();
}

class LosaDesRefScreenState extends State<LosaDesRefScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (Bsup1 == null) {
      ...
      Asup1 = Bsup1!.ab*B!/Nsup1!;
    }
    if (Bsup2 == null) {
      Asup2 = 0;
    }
    else {
      Asup2 = Bsup2!.ab*B!/Nsup2!;
    }
    if (Binf1 == null) {
      Ainf1 = 0;
    }
    else {
      Ainf1 = Binf1!.ab*B!/Ninf1!;
    }
    if (Binf2 == null) {
      Ainf2 = 0;
    }
    else {
      Ainf2 = Binf2!.ab*B!/Ninf2!;
    }
