...
class WDesEle extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return WDesEleScreen();
  }
}

class WDesEleScreen extends StatefulWidget {
  State createState() =>  WDesEleScreenState();
}

class WDesEleScreenState extends State<WDesEleScreen> {
    ...
    return Scaffold(
      ...
      body: ListView(
          children: [
            ...
            //           ),
            //           onPressed: (){
            //             print('Provider WSize ${wProvider.getSecSizeSel()}');
            //             print('Wtype $Wtype');
            ...
            MyResultButton(
              titulo: 'Ixx =',
              result: '${Ixx!.round()} in4 // ${round(Ixxcm,3).round()} cm4',
            ),
          ]),
    );
  }
