...
class MyTab_VigCon extends StatelessWidget {
  final String titulo;
  final listatab;
  final Widget loc;
  // var SeccSelec;
  ...
  MyTab_VigCon({required this.titulo, required this.listatab, required this.loc});

  // MyTab_VigCon({this.titulo, this.listatab, this.loc,
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
                    ...
                    SecProvider.setNsup1(2);
                    SecProvider.setNsup2(0);
                    SecProvider.setNinf1(2);
                    SecProvider.setNinf2(0);
                    ResProvider.setL(0);
        ...
        bottomNavigationBar: Consumer2<VigProvider, DemProvider>(
            ...
            onPressed: () {
              if (SecProvider.getHVig() != null &&
                ...
                //CALCULO DE CAPACIDAD
                  ...
                  fMnn = fis!*(Ass!*fy!)*(ds!-as!/2)/100;
                  fMnn = round(fMnn, 0);
                  fMnp = fii!*(Asi!*fy!)*(di!-ai!/2)/100;
                  fMnp = round(fMnp, 0);
                  fVn =round(0.75*(0.53*sqrt(fc!)*b!*MinVal([ds,di])+Asv!*fyv!*MinVal([ds,di])/sep!),0);
                ...
                content:
                (SecProvider.getHVig() == null || SecProvider.getHVig() == 0.0) ? Text('Falta definir peralte de viga'):
                (SecProvider.getBVig() == null || SecProvider.getBVig() == 0.0) ? Text('Falta definir ancho de viga'):
